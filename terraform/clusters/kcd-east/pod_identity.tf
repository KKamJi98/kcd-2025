...
###############################################
# Pod Identity for AWS Load Balancer Controller (kcd-east)
###############################################

# IAM policy for ALB Controller (from templates/aws_load_balancer_policy.json)
resource "aws_iam_policy" "aws_load_balancer_controller_policy" {
  name        = "kkamji-aws-lbc-policy-east"
  description = "Permissions for AWS Load Balancer Controller (east)"
